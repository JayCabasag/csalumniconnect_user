...
const UserEmployment= ({userId}) => {
  ...
  return (
    <div className='w-full px-3 flex flex-col'>
        ...
        {
          success?
          <p className='text-green-600 text-sm'>Information successfully!</p>
          :
          null
        }
        ...
        {
          error?
          <p className='text-rose-600 text-sm'>Updating information failed!</p>
          :
          null
        }
